...
public interface BaseController <E extends Base, ID extends Serializable> {
    ...
    public ResponseEntity<?> getRecordBy(Pageable pageable, @RequestParam(name = "sort", required = false) String sort, @RequestParam(name = "search", required = true) String search);
}